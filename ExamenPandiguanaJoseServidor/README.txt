...
a persistence unit "ExamenPandiguanaJoseServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenPandiguanaJoseServidor\pom.xml":
...
artifact ("ExamenPandiguanaJoseServidor.war") is already built. You can build
