...
a persistence unit "ExamenPandiguanaJoseClientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenPandiguanaJoseCliente\pom.xml":
...
artifact ("ExamenPandiguanaJoseCliente.war") is already built. You can build
